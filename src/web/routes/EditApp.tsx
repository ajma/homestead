...
/**
 * `overview`, `containers`, `logs` today; Phase 1F adds `compose` and `env`. A list
 * rather than three literals scattered across the nav markup, so a later tab is one
 * entry here plus one child `<Route>` in `App.tsx` — not a hunt through JSX.
 *
